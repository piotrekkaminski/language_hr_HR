...
# Version & progress
This translation is generated from the branch [2.1.8](https://crowdin.com/project/magento-2/hr#/2.1.8) at Crowdin and based on the Magento 2.1.8 sourcefiles.
...
# Contribute
To help move the '*Croatian (hrvatski) Magento2 Language Pack (hr_HR)*' forward please goto [this](https://crowdin.com/project/magento-2/hr) crowdin page and translate the untranslated string or propose better translations.
